...
def _arm_listener(empirica_dir, name="foo", monitor_task_id="tk-monitor", curl_pid=12345):
...
class TestPauseHandlerWithActiveListener:
    def test_armed_listener_writes_pending_uninstall(self, empirica_dir, capsys):
        ...
        _arm_listener(empirica_dir, name="foo", monitor_task_id="tk-monitor", curl_pid=12345)
