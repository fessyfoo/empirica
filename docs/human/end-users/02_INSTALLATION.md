...
```bash
# Standard image
docker pull nubaeon/empirica:1.12.4

# Security-hardened Alpine (recommended)
docker pull nubaeon/empirica:1.12.4-alpine

# Run
docker run -it -v $(pwd)/.empirica:/data/.empirica nubaeon/empirica:1.12.4 /bin/bash
```
