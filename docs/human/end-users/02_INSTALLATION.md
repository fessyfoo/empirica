...
```bash
# Standard image
docker pull nubaeon/empirica:1.12.23

# Security-hardened Alpine (recommended)
docker pull nubaeon/empirica:1.12.23-alpine

# Run
docker run -it -v $(pwd)/.empirica:/data/.empirica nubaeon/empirica:1.12.23 /bin/bash
```
