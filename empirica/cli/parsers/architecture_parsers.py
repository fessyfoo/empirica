...
def add_architecture_parsers(subparsers):
    ...
    assess_parser.add_argument("path", help="Path to file or package to assess (relative or absolute)")
    assess_parser.add_argument(
        "--project-root", default=".", help="Root directory of the project (default: current directory)"
    )
    assess_parser.add_argument(
        "--output", choices=["text", "json", "summary"], default="text", help="Output format (default: text)"
    )
    ...
    compare_parser.add_argument("path_a", help="First component path")
    compare_parser.add_argument("path_b", help="Second component path")
    ...
    dir_parser.add_argument("path", help="Directory to assess")
    dir_parser.add_argument(
        "--project-root", default=".", help="Root directory of the project (default: current directory)"
    )
    dir_parser.add_argument("--output", choices=["text", "json"], default="text", help="Output format (default: text)")
    dir_parser.add_argument("--top", type=int, default=10, help="Show top N worst components (default: 10)")
    dir_parser.add_argument(
        "--include-init",
        action="store_true",
