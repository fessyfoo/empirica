...
[![Version](https://img.shields.io/badge/version-1.9.9-blue)](https://github.com/Nubaeon/empirica/releases/tag/v1.9.9)
...
docker pull nubaeon/empirica:1.9.9-alpine

# Standard image (Debian slim, ~414MB)
docker pull nubaeon/empirica:1.9.9

# Run
docker run -it -v $(pwd)/.empirica:/data/.empirica nubaeon/empirica:1.9.9 /bin/bash
```
</details>
