...
[![Version](https://img.shields.io/badge/version-1.12.2-blue)](https://github.com/Nubaeon/empirica/releases/tag/v1.12.2)
...
docker pull nubaeon/empirica:1.12.2-alpine

# Standard image (Debian slim, ~414MB)
docker pull nubaeon/empirica:1.12.2

# Run
docker run -it -v $(pwd)/.empirica:/data/.empirica nubaeon/empirica:1.12.2 /bin/bash
```
</details>
