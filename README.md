...
[![Version](https://img.shields.io/badge/version-1.12.3-blue)](https://github.com/Nubaeon/empirica/releases/tag/v1.12.3)
...
docker pull nubaeon/empirica:1.12.3-alpine

# Standard image (Debian slim, ~414MB)
docker pull nubaeon/empirica:1.12.3

# Run
docker run -it -v $(pwd)/.empirica:/data/.empirica nubaeon/empirica:1.12.3 /bin/bash
```
</details>
