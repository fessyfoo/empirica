...
[![Version](https://img.shields.io/badge/version-1.10.6-blue)](https://github.com/Nubaeon/empirica/releases/tag/v1.10.6)
...
docker pull nubaeon/empirica:1.10.6-alpine

# Standard image (Debian slim, ~414MB)
docker pull nubaeon/empirica:1.10.6

# Run
docker run -it -v $(pwd)/.empirica:/data/.empirica nubaeon/empirica:1.10.6 /bin/bash
```
</details>
