...
[![Version](https://img.shields.io/badge/version-1.12.25-blue)](https://github.com/EmpiricaAI/empirica/releases/tag/v1.12.25)
...
docker pull nubaeon/empirica:1.12.25-alpine

# Standard image (Debian slim, ~414MB)
docker pull nubaeon/empirica:1.12.25

# Run
docker run -it -v $(pwd)/.empirica:/data/.empirica nubaeon/empirica:1.12.25 /bin/bash
```
</details>
