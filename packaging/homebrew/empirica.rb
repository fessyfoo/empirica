...
class Empirica < Formula
  ...
  url "https://files.pythonhosted.org/packages/source/e/empirica/empirica-1.10.4.tar.gz"
  sha256 "55623502c0faf6e4dd469814e9ad9787259c42a795a647752ebfae392962bc91"
  license "MIT"
  ...
  test do
    ...
    assert_match "1.10.4", shell_output("#{bin}/empirica --version")
