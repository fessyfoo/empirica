...
class Empirica < Formula
  ...
  url "https://files.pythonhosted.org/packages/source/e/empirica/empirica-1.12.22.tar.gz"
  sha256 "ca9b970552b40af9ea6ff38b4e250d06bf1fba4dcadf96908c23f25a7b3150ff"
  license "MIT"
  ...
  test do
    ...
    assert_match "1.12.22", shell_output("#{bin}/empirica --version")
